 ...
 * 
 */
public class InnerSuperpositionalEditorPanel extends JPanel implements
		ListSelectionListener, ActionListener {

	private final JList						test_case_list;
	private final JButton					addTestCase;
	private final SuperPositionalTestSet	tset;
	...
	public InnerSuperpositionalEditorPanel(SuperPositionalTestSet tset) {
		super();
		this.tset = tset;
