...
This can be seen in Figure \textbf{NEEDS A FIGURE}.
...
The way in which quantum algorithms and the circuits they produce work to correctly carry out the intended task is usually subtly and hard to understand by simply looking at the circuit.
To improve the 
