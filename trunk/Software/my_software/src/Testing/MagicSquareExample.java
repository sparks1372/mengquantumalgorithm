...
public class MagicSquareExample {
	...
	// /** Generate magic square test Tensor_Matrix. **/
	//
	// public static Tensor_Matrix magic(int n) {
	//
	...
	public static void main(String argv[]) {
		...
		// * equal trace. | rank = linear algebraic rank, | should equal n if n
		// is
		...
		// */
		//
		// print("\n    Test of Tensor_Matrix Class, using magic squares.\n");
		...
		Matrix state = new Matrix(state_array);

		Matrix result = tens_mat.times(state);
