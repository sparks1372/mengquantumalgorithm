...
public class Create_C_PauliY extends GPNode {

	public Create_C_PauliY() {
		children = new GPNode[3];
	}

	@Override
	public String toString() {
		return "Create_C_PauliY()";
	}
	...
	public void eval(EvolutionState state, int thread, GPData input,
		...
		for (int index = 0; index < Qprob.NUM_OF_QUBITS; index++) {
			if (index == ctrl) {
				...
				Qprob.circuit[index].add(new CU(targ, ctrl, new Pauli_Y(),
	...
	public static void main(String[] args) {
		Create_C_PauliY test_create_c_PauliY = new Create_C_PauliY();
		QuantumProblem qprob = new QuantumProblem(2);

		test_create_c_PauliY.children[0] = new Qubit(0);
		test_create_c_PauliY.children[1] = new Qubit(1);

		test_create_c_PauliY.eval(null, 0, new QPaceIVQuantumState(), null,
				null, qprob);
