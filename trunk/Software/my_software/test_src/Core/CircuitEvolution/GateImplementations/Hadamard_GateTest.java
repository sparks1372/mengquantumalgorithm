...
public class Hadamard_GateTest {
	...
	public void testApply() {
		...
		state_array[0][0] = new Complex(1 / Math.sqrt(2), 0);
		state_array[1][0] = new Complex(1 / Math.sqrt(2), 0);
		...
		state_array[2][0] = new Complex(1 / Math.sqrt(2), 0);
		...
		state_array[3][0] = new Complex(1 / Math.sqrt(2), 0);
