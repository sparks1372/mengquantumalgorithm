...
public class RXGateTest {
	...
	public void testApply() {
		...
		state_array[1][0] = new Complex(0, -Math.sin(theta / 2));
		...
		state_array[0][0] = new Complex(0, -Math.sin(theta / 2));
		...
		state_array[2][0] = new Complex(0, -Math.sin(theta / 2));
		...
		state_array[3][0] = new Complex(0, -Math.sin(theta / 2));
