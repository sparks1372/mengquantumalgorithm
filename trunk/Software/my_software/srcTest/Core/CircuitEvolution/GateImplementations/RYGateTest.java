...
public class RYGateTest {
	...
	public void testApply() {
		...
		oracle.set(1, 0, new Complex(Math.sin(theta / 2), 0));
		...
		oracle = new Matrix(2, 1);
		oracle.set(0, 0, new Complex(-Math.sin(theta / 2), 0));
		...
		oracle.set(0, 0, new Complex(Math.cos(theta / 2), 0));
		oracle.set(2, 0, new Complex(Math.sin(theta / 2), 0));
		...
		oracle = new Matrix(4, 1);
		oracle.set(1, 0, new Complex(Math.cos(theta / 2), 0));
		oracle.set(3, 0, new Complex(Math.sin(theta / 2), 0));
