...
public class Create_Swap extends GPNode {
	...
	public void eval(EvolutionState state, int thread, GPData input,
		...
		for (int index = 0; index < Qprob.NUM_OF_QUBITS; index++) {
			if (index == ctrl) {
				...
				Qprob.circuit[index].add(new SwapGate(targ, ctrl,
	...
	public static void main(String[] args) {
		Create_Swap test_create_ch = new Create_Swap();
		QuantumProblem qprob = new QuantumProblem(3);

		test_create_ch.children[0] = new Qubit(0);
		test_create_ch.children[1] = new Qubit(2);
		...
		state_0_array[1][0] = new Complex(0.25, 0);
		state_0_array[2][0] = new Complex(0, 0);
		state_0_array[3][0] = new Complex(0.25, 0);
		state_0_array[4][0] = new Complex(0.25, 0);
		state_0_array[5][0] = new Complex(0, 0);
		state_0_array[6][0] = new Complex(0, 0);
		state_0_array[7][0] = new Complex(0.25, 0);
